...
console.log("entro al doneeee");
    ...
    //for(var i=0; i<data.datos.length;i++){
      ...
      console.log('entro aca y weaaaa id: '+data.datos.deporte_id);

      ///categoria comienzo
document.getElementById("modalTitulo").innerHTML=data.datos.deporte_nombre;
      document.getElementById("modalParrafo").innerHTML=data.datos.deporte_descripcion;
      document.getElementById("modalImagen").innerHTML="<img src='"+data.datos.deporte_imagen_p+"'/>'";
